...
<input class="boutton" type="submit" name="repondre" value="Ajouter une réponse"/></a>';
 
//On affiche l'image nouveau topic
echo'<a href="./poster.php?action=nouveautopic&amp;f='.$data['forum_id'].'">
<input class="boutton1" type="submit" name="nouveautopic" value="Nouveau topic"/></a>';
$query->CloseCursor(); 
...
//On commence à afficher le pseudo du créateur du message :
         ...
         <input class="boutton_poster" type="submit"  name="Editer" value="Editer" value="Editer"/></a></td></tr>';
         }
         else
         {
         echo'<td>
